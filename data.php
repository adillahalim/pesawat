        ...
        <table class="table table-bordered mt-3">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th scope="col">
                      <center>Kelas Penerbangan</center>
                    </th>  
                    <th scope="col">
                    ...
                    <th scope="col">
                      <center>Tgl Berangkat</center>
                    </th>  
                    <th scope="col">
                      <center>Tgl Pulang</center>
                    </th>  
                </tr>
            </thead>
            <tbody>
                ...
                <?php foreach ($tiket as $row) : ?>
                    <tr>
                        ...
                        <th><a href="edit.php?id=<?= $row["idTiket"]; ?>">Edit</a>
                            <a href="hapus.php?id=<?= $row["idTiket"]; ?>" onclick="return confirm('Lanjutkan Hapus?');" class="text-danger">Hapus</a></th>
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
            </tbody>
